...
WebUI.click(findTestObject('Object Repository/SMS-ICT/Page_PUPSRC-SMS/i_Dashboard_sidenav-toggler-line'))

WebUI.click(findTestObject('Object Repository/SMS-ICT/Page_PUPSRC-SMS/a_Computer Laboratory'))

WebUI.click(findTestObject('Object Repository/SMS-ICT/Page_PUPSRC-SMS/span_Computer Laboratory Reservation'))
