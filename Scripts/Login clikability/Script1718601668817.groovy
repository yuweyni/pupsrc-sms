...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_PUPSMS/input__password'), '1b6ODxiWDdU=')

WebUI.setText(findTestObject('Object Repository/Page_PUPSMS/input__password_1'), 'secret')
