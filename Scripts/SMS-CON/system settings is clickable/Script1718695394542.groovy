...
WebUI.click(findTestObject('Object Repository/Page_PUPSRC-SMS/svg'))

WebUI.verifyElementClickable(findTestObject('Object Repository/Page_PUPSRC-SMS/div_System Settings'))
